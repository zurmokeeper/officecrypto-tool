...
Now it supports encryption and decryption of` MS office and WPS files`, Support `doc docx xls xlsx ppt pptx` decryption, support xls encryption in BIFF8 and BIFF5 formats. support `docx xlsx pptx` encryption.
